    ...
    <AdminLayout>
        <section class="space-y-8">
            ...
            <div class="flex justify-center">
                <form @submit.prevent="createMaterial" class="w-full max-w-3xl space-y-6 rounded-xl bg-[rgba(0,0,0,0.85)] p-6 shadow-xl">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p v-if="errors.material_name" class="mt-1 text-xs text-red-400">
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                            ></textarea>
                            <p v-if="errors.material_description" class="mt-1 text-xs text-red-400">
                                {{ errors.material_description[0] }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p v-if="errors.material_quantity" class="mt-1 text-xs text-red-400">
                                {{ errors.material_quantity[0] }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <p v-if="errors.status" class="mt-1 text-xs text-red-400">
                                {{ errors.status[0] }}
                            </p>
                        </div>
                    </div>
...
async function createMaterial() {
    ...
    try {
        await axios.post(route('admin.materials.store'), form.value);
        form.value = {
            material_name: '',
            material_description: '',
            material_quantity: 0,

    ...
    <AdminLayout>
        <section class="space-y-8">
            ...
            <div class="border-b border-[#00f5a0]/30 pb-4">
                ...
                <p class="text-sm text-[#7fbfb0]">Manage registered materials and their details.</p>
            </div>
            ...
            >
                ...
                <template #toolbar>
                    ...
                    <button 
                        @click="go" 
                        class="rounded-md bg-[#00f5a0] px-4 py-2 font-semibold text-black hover:bg-[#00c88a]"
                    >
                        Add
                    </button>
                </template>
...
async function deleteMaterial(material) {
    try {
        const confirmed = window.confirm(
            `Are you sure you want to delete material "${material.material_name}"?`
        )
        if (!confirmed) return

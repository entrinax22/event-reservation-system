    ...
    <AdminLayout>
        <section class="space-y-8">
            ...
            <div class="border-b border-[#00f5a0]/30 pb-4">
                ...
                <p class="text-xl text-white">Create and manage events.</p>
            </div>

            <!-- Centered Form Wrapper -->
            <div class="flex justify-center">
                <form @submit.prevent="createEvent" class="w-full max-w-3xl space-y-6 rounded-xl bg-[rgba(0,0,0,0.85)] p-6 shadow-xl">
                    ...
                    <div class="grid grid-cols-1 gap-y-4">
                        ...
                        <div>
                            ...
                            <input
                                ...
                                required
                            />
                            <p v-if="errors.event_name" class="mt-1 text-xs text-red-400">
                                {{ errors.event_name[0] }}
                            </p>
                        </div>
                        ...
                        <div>
                            ...
                            <textarea
                                ...
                                required
                            ></textarea>
                            <p v-if="errors.event_description" class="mt-1 text-xs text-red-400">
...
async function createEvent() {
    ...
    try {
        await axios.post(route('admin.events.store'), form.value);
